...
//////////////////////////////////////////////////////////
/*
export var netobj_type = lodash.enum("group", "netmask", "range");
export var netobj_ipver = lodash.enum("v4", "v6");
export var netobj_protocol = lodash.enum("icmp=1", "tcp=6", "udp=17", "all=255");
// export var ipnode_visible = lodash.enum("none", "hide", "show");

export const netobj_type_list = [
  { text: "Group", value: netobj_type.group },
  { text: "Netmask", value: netobj_type.netmask },
  { text: "Range", value: netobj_type.range },
];

export const netobj_ipver_list = [{ text: "IPv4", value: netobj_ipver.v4 }, { text: "IPv6", value: netobj_ipver.v6 }];

export class netobj extends baseclass.baseobj {
  constructor(id) {
    super(id);
    this.type = netobj_type.netmask;

    // for network
    this.ipaddr_ver = netobj_ipver.v4;
    this.ipaddr_start = "";
    this.ipaddr_end = "";
    this.netmask = 0;
...
/*
export function init_sample_netobj(netobjset) {
  let a = new netobj();
  a.id = "id-ssh-server";
  // a.name = "ssh-server";
  a.desc = "SSH Server";
  ...
  a.type = netobj_type.range;
  a.ipaddr_ver = netobj_ipver.v4;
  a.ipaddr_start = "204.152.188.196";
  a.ipaddr_end = "204.152.188.196";
  a.protocol = netobj_protocol.tcp;
  a.port_start = 22;
  a.port_end = 22;
  ...
  b.type = netobj_type.range;
  b.ipaddr_ver = netobj_ipver.v4;
  b.ipaddr_start = "0.0.0.0";
  b.ipaddr_end = "0.0.0.0";
  b.protocol = netobj_protocol.tcp;
  b.port_start = 80;
  b.port_end = 80;
  ...
  c.type = netobj_type.range;
  c.ipaddr_ver = netobj_ipver.v4;
  c.ipaddr_start = "0.0.0.0";
  c.ipaddr_end = "0.0.0.0";
  c.protocol = netobj_protocol.all;
  c.port_start = 0;
  c.port_end = 65535;
  ...
  d.id = "netobj-d";
  // d.name = "WebServer4";
  d.type = netobj_type.range;
  d.ipaddr_ver = netobj_ipver.v4;
  ...
  e.id = "netobj-e";
  // e.name = "WebServer5";
  e.type = netobj_type.netmask;
  e.ipaddr_ver = netobj_ipver.v4;
  e.ipaddr_start = "172.1.1.1";
  e.ipaddr_end = "172.1.1.254";
  e.netmask = 24;
  ...
  f.id = "netobj-f";
  // f.name = "Group6";
  f.type = netobj_type.group;
  f.ipaddr_ver = netobj_ipver.v4;
  f.ipaddr_start = "";
  f.ipaddr_end = "";
  f.netmask = 0;
